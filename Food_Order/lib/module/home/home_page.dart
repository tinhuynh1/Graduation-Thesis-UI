              ...
              children: <Widget>[
                ...
                StreamBuilder(
                  ...
                  stream: HomeBloc.getInstance(userRepo: Provider.of(context))
                      .getListCategoryPost(),
                  builder: (BuildContext context,
                          AsyncSnapshot<List<CategoryPost>> snapshot) =>
                      ListView.builder(
                    ...
                    itemBuilder: (context, index) => Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          HomeTitle(text: snapshot.data[index].categoryName),
                          Container(
                            padding: EdgeInsets.only(top: 10),
                            height: 310,
                            child: ListView.builder(
                              itemCount: snapshot.data[index].listPost.length,
                              scrollDirection: Axis.horizontal,
                              shrinkWrap: true,
                              itemBuilder: (context, indexChild) {
                                return SliderHome(
                                  img: snapshot
                                      .data[index].listPost[indexChild].poster,
                                  title: snapshot
                                      .data[index].listPost[indexChild].title,
                                  desc: snapshot.data[index]
                                      .listPost[indexChild].shortContent,
                                );
                              },
                            ),
                          ),
